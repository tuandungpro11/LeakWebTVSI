...
const PagesRoutes = [
  ...
  {
    path: "/crm/potential-customer/detail/:id",
    component: lazy(() => import("@modules/crm/potential-customer/detail")),
    meta: {
      navLink: "/crm/potential-customer",
    },
  },
  {
    path: "/crm/potential-customer/detail",
    exact: true,
    component: () => <Redirect to="/crm/customer" />,
  },
  {
    path: "/crm/customer/detail/:id",
    component: lazy(() => import("@modules/crm/customers/detail")),
    meta: {
  ...
  {
    path: "/crm/potential-customer/edit/:id",
    component: lazy(() => import("@modules/crm/potential-customer/edit")),
    meta: {
      navLink: "/crm/potential-customer",
    },
  },
  {
    path: "/crm/potential-customer/edit",
    exact: true,
    component: () => <Redirect to="/crm/potential-customer" />,
  },
  {
    path: "/crm/potential-customer/create",
    exact: true,
    component: lazy(() => import("@modules/crm/potential-customer/create")),
    meta: {
      navLink: "/crm/potential-customer",
    },
  },
  {
    path: "/crm/potential-customer",
    component: lazy(() => import("@modules/crm/potential-customer/list")),
  },
  {
    path: "/crm/customer",
    component: lazy(() => import("@modules/crm/customers/list")),
  },
  {
    path: "/crm/activity",
    component: lazy(() => import("@modules/crm/activities")),
  },
  // {
  //   path: "/pages/login-v1",
