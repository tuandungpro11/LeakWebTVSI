...
const FormDetail = (valueUpdate: any) => {
  ...
  const defaultValue = {
    ...
    ModifyBy: valueBind.ModifiedBy,
    ModifyDate: Moment.formatDateNew(valueBind.ModifiedDate,"DD/MM/yyyy HH:mm:ss"),
    CreateBy: valueBind.CreateBy,
    CreateDate: Moment.formatDateNew(valueBind.CreateDate,"DD/MM/yyyy HH:mm:ss"),
  };
            ...
            >
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Phí chuyển tiền không được để trống",
                  },
                ]}
              >
                <Input
              ...
              <Form.Item
                label={t("X_Trade_Create_By")}
                name="CreateBy"
              >
                <Input placeholder={t("X_Trade_Create_By")} autoComplete="off" 
                  disabled/>
              </Form.Item>
              <Form.Item
                label={t("X_Trade_Create_Date")}
                name="CreateDate"
              >
                <Input placeholder={t("X_Trade_Create_Date")} autoComplete="off" 
                  disabled/>
              </Form.Item>
              <Form.Item
                label={t("X_Trade_Modify_By")}
                name="ModifyBy"
              >
                <Input placeholder={t("X_Trade_Modify_By")} autoComplete="off" 
                  disabled/>
              </Form.Item>
              <Form.Item
                label={t("X_Trade_Modify_Date")}
                name="ModifyDate"
              >
                <Input placeholder={t("X_Trade_Modify_Date")} autoComplete="off" 
                  disabled/>
              </Form.Item>
            </PerfectScrollbar>
