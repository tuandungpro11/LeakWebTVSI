...
import { DepositColumnsType, listAPI, pageSizeTable  } from "../type";
...
const ListCustormer = () =>
  useObserver(() => {
    ...
    const columnsCustormer: ColumnsType<DepositColumnsType> = [
      {
        title: "STT",
        render: (v, s, index) =>
          index +
          1 +
          (reportStore.pageIndexDeposit - 1) * reportStore.pageSizexDeposit,
        width: 50,
        align: "center",
        fixed: "left",
      },
    ...
    const resetForm = () => {
      form.resetFields();
      if (reportStore.pageIndexDeposit == 1) {
        onSubmit();
      } else {
        reportStore.pageIndexDeposit = 1;
      }
    };
              ...
              <Col sm="24" md="24">
                <Table
                  ...
                  pagination={{
                    ...
                    onShowSizeChange:
                      reportStore.handlePerRowsChangeCustormerDeposit,
                    pageSizeOptions: pageSizeTable,
                    total: reportStore.totalRowsDob,
                    showTotal: showTotal,
                    onChange: reportStore.handlePageChangeCustormerDeposit,
                    className: "mt-1 text-right custom-ant-pagination",
                    defaultCurrent: reportStore.pageIndexDeposit,
                    locale: { items_per_page: "/ trang" },
                    current: reportStore.pageIndexDeposit,
                  }}
                />
              </Col>
            </Row>
