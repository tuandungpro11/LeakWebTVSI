...
import { listAPI, pageSizeTable } from "../type";
...
const ListCustormer = () =>
  useObserver(() => {
    ...
    const columnsCustormer: ColumnsType<ActiveColumnsType> = [
      {
        title: "STT",
        render: (v, s, index) =>
          index +
          1 +
          (reportStore.pageIndexActive - 1) * reportStore.pageSizexActive,
        width: 50,
        align: "center",
        fixed: "left",
      },
    ...
    const resetForm = () => {
      form.resetFields();
      if (reportStore.pageIndexActive == 1) {
        onSubmit();
      } else {
        reportStore.pageIndexActive = 1;
      }
    };
    ...
    const exportExcel = () => {
      ...
      reportStore.ExportListUI(listAPI.apiExport, param, "BAO_CAO_KH_ACTIVE");
    };
              ...
              <Col sm="24" md="24">
                <Table
                  ...
                  pagination={{
                    ...
                    onShowSizeChange:
                      reportStore.handlePerRowsChangeCustormerActive,
                    pageSizeOptions: pageSizeTable,
                    total: reportStore.totalRowsDob,
                    showTotal: showTotal,
                    onChange: reportStore.handlePageChangeCustormerActive,
                    className: "mt-1 text-right custom-ant-pagination",
                    defaultCurrent: reportStore.pageIndexActive,
                    locale: { items_per_page: "/ trang" },
                    current: reportStore.pageIndexActive,
                  }}
                />
              </Col>
            </Row>
