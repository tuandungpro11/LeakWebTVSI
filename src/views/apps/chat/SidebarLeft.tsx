...
const SidebarLeft = (props: any) => {
  ...
  const handleUserClick = (type: any, id: any) => {
            ...
            <ul className="list-unstyled user-status">
              ...
              <li className="pb-1">
                ...
                <CustomInput
                  ...
                  id="online"
                  label="Online"
                  onChange={(e: any) => setStatus("online")}
              ...
              <li className="pb-1">
                ...
                <CustomInput
                  ...
                  id="offline"
                  label="Offline"
                  onChange={(e: any) => setStatus("offline")}
