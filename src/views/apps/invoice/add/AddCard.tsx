...
const AddCard = () => {
    ...
    axios
      ...
      .then((response) => {
        const lastInvoiceNumber = Math.max.apply(
          Math,
          response.data.allData.map((i: any) => i.id)
        );
  ...
  const handleInvoiceToChange = (data: any) => {
    ...
    setSelected(clients.filter((i: any) => i.name === data.value)[0]);
  };
          ...
          <div className="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
            ...
            <div>
              ...
              <div className="logo-wrapper">
                ...
                <h3 className="text-primary invoice-logo">TVSI</h3>
              </div>
            ...
            <div className="invoice-number-date mt-md-0 mt-2">
              ...
              <div className="d-flex align-items-center mb-1">
                ...
                <Flatpickr
                  value={picker}
                  onChange={(date: any) => setPicker(date)}
              ...
              <div className="d-flex align-items-center">
                ...
                <Flatpickr
                  value={dueDatepicker}
                  onChange={(date: any) => setDueDatePicker(date)}
