...
const Tasks = (props: any) => {
  ...
  const handleTaskClick = (obj: any) => {
    dispatch(selectTask(obj));
    handleTaskSidebar();
  };

  // ** Returns avatar color based on task tag
  const resolveAvatarVariant = (tags: any) => {
    ...
    >
      {tasks.length ? (
        <ReactSortable
          ...
          setList={(newState: any) => dispatch(reOrderTasks(newState))}
        >
          {tasks.map((item: any) => (
            <li
              key={item.id}
        ...
        <UncontrolledDropdown>
          ...
          <DropdownMenu right>
            <DropdownItem
              tag={Link}
              to="/"
              onClick={(e: any) => handleSort(e, "title-asc")}
            >
              Sort A-Z
            </DropdownItem>
            <DropdownItem
              tag={Link}
              to="/"
              onClick={(e: any) => handleSort(e, "title-desc")}
            >
              Sort Z-A
            </DropdownItem>
            <DropdownItem
              tag={Link}
              to="/"
              onClick={(e: any) => handleSort(e, "assignee")}
            >
              Sort Assignee
            </DropdownItem>
            <DropdownItem
              tag={Link}
              to="/"
              onClick={(e: any) => handleSort(e, "due-date")}
            >
              Sort Due Date
            </DropdownItem>
            <DropdownItem
