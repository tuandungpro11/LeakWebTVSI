...
const MailDetails = (props: any) => {
  ...
  // ** Renders Labels
  const renderLabels = (arr: any) => {
    if (arr && arr.length) {
          return arr.map((label: any) => (
        <Badge
          key={label}
  ...
  // ** Renders Attachments
  const renderAttachments = (arr: any) =>
  ...
  const handleFolderClick = (e: any, folder: any, id: any) => {
                  ...
                  <UncontrolledDropdown>
                    ...
                    <DropdownMenu right>
                      ...
                      <DropdownItem
                        ...
                        href="/"
                        onClick={(e: any) =>
                          handleFolderClick(e, "draft", mail.id)
                        }
                      ...
                      <DropdownItem
                        ...
                        href="/"
                        onClick={(e: any) =>
                          handleFolderClick(e, "spam", mail.id)
                        }
                        className="d-flex align-items-center"
                      >
                      ...
                      <DropdownItem
                        ...
                        href="/"
                        onClick={(e: any) =>
                          handleFolderClick(e, "trash", mail.id)
                        }
                        className="d-flex align-items-center"
                      >
