  ...
  <Card>
    ...
    <CardBody>
      ...
      <p>
        ...
        have created gradient colors based on our default colors, use below
      ...
      <p>
        ...
        each color, we think has its functionality in the application as alerts
        of errors <b>(danger)</b>, warnings to the user <b>(warning)</b>,
