  ...
  <Card>
    ...
    <CardBody>
      <CardText>
         ...
         All HTML headings are available with light and
        bold font-weight. Use <code>.font-weight-normal</code> for light
        heading and <code>.font-weight-bolderer</code> for bold headings along
        with heading tags or classes.
      </CardText>
    </CardBody>
