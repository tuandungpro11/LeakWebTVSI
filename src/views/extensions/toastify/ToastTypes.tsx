  ...
  <Fragment>
    ...
    <div className="toastify-header">
      ...
      <div className="title-wrapper">
        ...
        <h6 className="toast-title">Lỗi!</h6>
      </div>
    </div>
...
const SuccessProgressToast = (content:any) => (
  <Fragment>
    ...
    <div className="toastify-header">
      ...
      <div className="title-wrapper">        
      <Avatar size="sm" color="success" icon={<Check size={12} />} />
        <h6 className="toast-title">Thành công</h6>
      </div>
    </div>
...
export {SuccessProgressToast, ErrorToast};