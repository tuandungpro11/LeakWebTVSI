  ...
  <Card>
    ...
    <CardBody>
      <CardText>
         ...
         You can control width via utility classes with
        prop <code>className</code> such as <code>w-50</code>, 
        <code>w-75</code>, <code>w-100</code>, or use <code>style</code> prop to
        set the width.
      </CardText>
      <FormGroup>
