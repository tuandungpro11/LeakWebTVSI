        ...
        <Col sm="24">
          ...
          <Card title="Dark" code={tableDark} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                 Use prop <code>dark</code> to create
                a dark inverted table.
              </CardText>
            </CardBody>
          ...
          <Card title="Table head Options" code={tableTheadOptions} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                ...
                use the modifier classes <code>.thead-dark</code>
                 to make <code>
                  &lt;thead&gt;
                </code>{" "}
                appear dark.
          ...
          <Card title="Striped Dark" code={tableStripedDark} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                ...
                <code>dark</code> to create a dark striped table.
              </CardText>
            </CardBody>
        ...
        <Col sm="24">
          ...
          <Card title="Bordered" code={tableBordered} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                 Use prop <code>bordered</code> to
        ...
        <Col sm="24">
          ...
          <Card title="Borderless" code={tableBorderless} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                 Use prop <code>borderless</code> to
        ...
        <Col sm="24">
          ...
          <Card title="Hoverable" code={tableHover} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                 Use prop <code>hover</code> to create
                a hoverable table.
              </CardText>
            </CardBody>
        ...
        <Col sm="24">
          ...
          <Card title="Contextual classes" code={tableContextual} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                 Use class{" "}
                <code>table-[colorName]</code> with <code>&lt;tr&gt;</code> for
                contextual rows.
              </CardText>
            </CardBody>
        ...
        <Col sm="24">
          ...
          <Card title="Responsive" code={tableResponsive} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                 Use prop <code>responsive</code> to
        ...
        <Col sm="24">
          ...
          <Card title="Table Hover Animation" code={tableHoverAnimation} noBody>
            ...
            <CardBody>
              ...
              <CardText>
                 Use class{" "}
                <code>table-hover-animation</code> for Table Hover Animation.
              </CardText>
            </CardBody>
