...
const DataTableAdvSearch = () => {
  ...
  const handleNameFilter = (e: any) => {
    ...
    setSearchName(value);
    if (value.length) {
      updatedData = dataToFilter().filter((item: any) => {
  ...
  const handleSalaryFilter = (e: any) => {
    const { value } = e.target;
    let updatedData = [];
    const dataToFilter = () => {
      if (
            ...
            <Col lg="4" md="6">
              ...
              <FormGroup>
                ...
                <Flatpickr
                  ...
                  onChange={(date: any) => handleDateFilter(date)}
                />
              </FormGroup>
            </Col>
