        ...
        <Col sm="24">
          ...
          <Card title="Modal Basic" code={modalBasic}>
            ...
            <CardText className="mb-0">
               Use <code>Modal</code>, <code>ModalBody</code>{" "}
              and <code>ModalFooter</code> tags to create a Modal with
              reactstrap.
            </CardText>
      ...
      <Row>
        ...
        <Col sm="24">
          ...
          <Card title="Modal Sizes" code={modalSizes}>
            ...
            <CardText className="mb-0">
               Use class <code>.modal-[xs/sm/lg/xl]</code>{" "}
              with <code>ModalHeader</code> to change modal Size.
            </CardText>
        ...
        <Col sm="24">
          ...
          <Card title="Modal Events" code={modalEvents}>
            ...
            <CardText className="mb-0">
               Use props <code>onClosed / onOpened</code> for
              modal events.
            </CardText>
