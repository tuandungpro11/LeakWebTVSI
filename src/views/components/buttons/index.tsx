...
import ButtonDrawer from "@components/bottom-drawer";
      ...
      <Row>
        ...
        <Col sm="24">
          ...
          <Card title="Outline" code={outlineButtons}>
            ...
            <CardText className="mb-0">
               Use prop <code>outline</code> with button tag
        ...
        <Col sm="24">
          ...
          <Card title="Gradient" code={gradientButtons}>
            ...
            <CardText className="mb-0">
               Use <code>color="gradient-{"colorName"}"</code>{" "}
        ...
        <Col sm="24">
          ...
          <Card title="Icon Only" code={iconOnlyButtons}>
            ...
            <CardText className="mb-0">
               You can use class <code>.btn-icon</code>. You
              can create a rounded button by using 
              <code>.rounded-circle</code> with <code>.btn-icon</code>. You can
              only use <code>.btn-icon</code> when you only want icon in your
              button
            </CardText>
        ...
        <Col sm="24">
          ...
          <Card title="Block Level Buttons" code={buttonBlock}>
            ...
            <CardText>
               Use prop <code>block</code> to create a block
              button.
            </CardText>
        ...
        <Col sm="24">
          ...
          <Card title="Button drawer">
            
            <ButtonDrawer drawerButtons={drawerButtons} />
          </Card>
        </Col>
      </Row>
    </Fragment>
