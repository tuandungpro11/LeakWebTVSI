      ...
      <Row className="match-height">
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Border Spinner" code={spinnerBorder}>
            ...
            <CardText>
               Use <code>Spinner</code> tag to create a
              bordered spinner.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Colors" code={spinnerColors}>
            ...
            <CardText className="mb-0">
               Use <code>color</code> attribute to create a
              colored spinner.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Growing Spinner" code={spinnerGrowing}>
            ...
            <CardText>
               Use <code>type="grow"</code> with spinner tag
              to create a growing spinner.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Flex" code={spinnerFlex}>
            ...
            <CardText>
              ...
              <code>.d-flex</code> and <code>.justify-content-[side]</code>.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Float" code={spinnerFloat}>
            ...
            <CardText>
               Use <code>.float-[side]</code> with spinner tag
              to change spinner's position.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Sizes" code={spinnerSizes}>
            ...
            <CardText className="mb-0">
               Use prop <code>size="sm"</code> for Small
              spinner or use <code>style</code> prop for custom size.
            </CardText>
