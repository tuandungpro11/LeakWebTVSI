      ...
      <Row>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Interval Example" code={carouselInterval}>
            ...
            <CardText>
              ...
              between slides. default interval is <strong>5000</strong>.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Keyboard Example" code={carouselKeyboard}>
            ...
            <CardText>
               Use <code>Keyboard</code> prop to control
              carousel with keyboard default is <code>false</code>.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Pause Example" code={carouselPause}>
            ...
            <CardText>
               Use <code>pause</code> prop to pause carousel
              on hover.
            </CardText>
