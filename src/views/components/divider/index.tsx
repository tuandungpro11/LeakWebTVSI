      ...
      <Row>
        ...
        <Col sm="12">
          ...
          <Card title="Text" code={dividerText}>
            ...
            <CardText>
               Use class <code>.divider</code> as wrapper fors provided... 
          ...
          <Card title="Position" code={dividerPosition}>
            ...
            <CardText>
              ...
              <code>.divider-[left | left-center | right | right-center]</code>
               with <code>.divider</code> to set text
              position.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Style" code={dividerStyle}>
            ...
            <CardText>
               use class{" "}
              <code>.divider-[dotted | dashed]</code> to change divider style.
              solid is default style you don't have to add any class for it.
            </CardText>
