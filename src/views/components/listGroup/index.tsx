      ...
      <Row className="match-height">
        ...
        <Col lg="6" md="12">
          ...
          <Card title="Tags List Group" code={listGroupTag}>
            ...
            <CardText>
              ...
              <code>ListGroupItem</code> tag to change item's tag. You can use{" "}
              
              <code>active</code> prop with <code>ListGroupItem</code> tag to
              show an item as active. Use 
        ...
        <Col lg="6" md="12">
          ...
          <Card title="Contextual List Group" code={listGroupContextual}>
            ...
            <CardText>
              ...
              <code>ListGroupItem</code> to create a contextual list.
            </CardText>
        ...
        <Col lg="6" md="12">
          ...
          <Card title="Flush List Group" code={listGroupFlush}>
            ...
            <CardText>
              ...
              <code>ListGroup</code> tag to create a flush list group.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Horizontal List Group" code={listGroupHorizontal}>
            ...
            <CardText>
               Use class <code>.list-group-horizontal</code>{" "}
              to change the layout of list group items from vertical to
              horizontal across all breakpoints.choose a responsive variant
              code. 
