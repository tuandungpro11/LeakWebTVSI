      ...
      <Row>
        ...
        <Col sm="12">
          ...
          <Card title="Default" code={defaultAlert}>
            ...
            <CardText>
              ...
              well as an optional dismiss button. Use <code>Alert</code>  Component & <code>color</code> prop for alert
        ...
        <Col sm="12">
          ...
          <Card title="Colors" code={alertColors}>
            ...
            <CardText>
               Use <code>color</code> prop to for alert with
              all theme colors.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Dismissable Alert" code={alertDismissable}>
            ...
            <CardText>
               Using <code>isOpen</code> and{" "}
              <code>toggle</code> you can create a dismissable alert.
            </CardText>
