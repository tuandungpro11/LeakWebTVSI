  ...
  <div className="demo-inline-spacing">
    ...
    <UncontrolledPopover trigger="focus" placement="top" target="popFocus">
      ...
      <PopoverBody>
        ...
        (clicking away) makes it disappear. You cannot select this
        text as the popover will disappear when you try.
      </PopoverBody>
    </UncontrolledPopover>
    ...
    <UncontrolledPopover trigger="click" placement="top" target="popClick">
      ...
      <PopoverBody>
        ...
        on it again will make it disappear. You can select this text,
        but clicking away (somewhere other than the triggering element) will not
    ...
    <UncontrolledPopover placement="top" target="popLegacy">
      ...
      <PopoverBody>
        ...
        focus, it had a hybrid which was very useful and has been brought back
        as 
       trigger="legacy". One advantage of the legacy trigger is that
        it allows the popover text to be selected while also closing when
