      ...
      <Row>
        ...
        <Col sm="12">
          ...
          <Card title="Popover Positions" code={popoverPositions}>
            ...
            <CardText className="mb-0">
               Use prop <code>placement</code> to place you
              popover at desired position.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Popover Triggers" code={popoverTriggers}>
            ...
            <CardText className="mb-0">
               Use prop <code>trigger</code> for various
              trigger options. Trigger each popover to see information about the
              trigger.
            </CardText>
