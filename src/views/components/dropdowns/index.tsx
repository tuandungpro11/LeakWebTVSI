      ...
      <Row>
        ...
        <Col sm="24">
          ...
          <Card title="Split" code={dropdownSplit}>
            ...
            <CardText className="mb-0">
               Use class <code>.dropdown-toggle-split</code>{" "}
              and add a split button within your dropdown to create a
              dropdownSplit
            </CardText>
        ...
        <Col sm="24">
          ...
          <Card title="Outline" code={dropdownOutline}>
            ...
            <CardText className="mb-0">
               Use <code>.outline</code> attribute with button
              to create outline dropdown.
            </CardText>
        ...
        <Col sm="24">
          ...
          <Card title="Flat" code={dropdownFlat}>
            ...
            <CardText className="mb-0">
               Use class <code>color="flat-*"</code> to create
              a flat dropdown.
            </CardText>
        ...
        <Col sm="24">
          ...
          <Card title="Gradient" code={dropdownGradient}>
            ...
            <CardText className="mb-0">
               Use class <code>btn-gradient-*</code> to create
              a gradient dropdown.
            </CardText>
        ...
        <Col sm="24">
          ...
          <Card title="Variations" code={dropdownVariations}>
            ...
            <CardText>
              ...
              prop <code>header</code> for the header of groups and for  separation of group you can use prop{" "}
              <code>divider</code>.
            </CardText>
