      ...
      <Row>
        ...
        <Col sm="12">
          ...
          <Card title="Glow Badges" code={badgeGlow}>
            ...
            <CardText className="mb-0">
              ...
              <code>Badge</code> tag to add glow effect to your badge
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Light Badges" code={badgeLight}>
            ...
            <CardText className="mb-0">
               Use prop <code>color="light-COLOR_NAME"</code>{" "}
              with <code>Badge</code> tag to create badge with different colors.
            </CardText>
      ...
      <Row>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Link Badge" code={badgeLink}>
            ...
            <CardText>
               Use <code>href="#"</code> prop to use badge as
              a link.
            </CardText>
