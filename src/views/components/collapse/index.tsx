      ...
      <Row>
        ...
        <Col sm="12">
          ...
          <Card title="Accordion" code={accordion}>
            ...
            <CardText>
               You may want to open one item at a time for
              that you can use prop <code>accordion</code>.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Accordion Shadow" code={accordionShadow}>
            ...
            <CardText>
               Use prop <code>type='shadow'</code> to create
              collapse/accordion with shadow.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Accordion Border" code={accordionBorder}>
            ...
            <CardText>
               Use prop <code>type='border'</code> to create
              collapse/accordion with border.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Accordion Margin" code={accordionMargin}>
            ...
            <CardText>
               Use prop <code>type='margin'</code> to create
              collapse/accordion with margin.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Accordion Hover" code={accordionHover}>
            ...
            <CardText>
               Use prop <code>toggle='hover'</code> to create
              hoverable collapse/accordion.
            </CardText>
