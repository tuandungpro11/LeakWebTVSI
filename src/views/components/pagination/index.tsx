      ...
      <Row className="match-height">
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Success" code={paginationSuccess}>
            ...
            <CardText>
               Use class <code>.pagination-success</code> withs provided
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Danger" code={paginationDanger}>
            ...
            <CardText>
               Use class <code>.pagination-danger</code> withs provided
              <code>pagination</code> tag.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Warning" code={paginationWarning}>
            ...
            <CardText>
               Use class <code>.pagination-warning</code> withs provided
              <code>pagination</code> tag.
            </CardText>
