      ...
      <Row>
        ...
        <Col lg="12">
          ...
          <Card title="Colored Progress" code={progressColored}>
            ...
            <CardText>
               Use <code>progress-bar-[color]</code> class
              with progress to change progress color.
            </CardText>
        ...
        <Col lg="12">
          ...
          <Card title="Multiple Stacked" code={progressMultipleStacked}>
            ...
            <CardText>
               To create a multi colored progress wrap all of
              your progresses in with <code>multi</code> prop.
            </CardText>
