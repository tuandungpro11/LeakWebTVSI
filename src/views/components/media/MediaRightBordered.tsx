  ...
  <div className="media-list media-bordered">
    <Media>
      ...
      <Media className="text-right" body>
        ...
        cake topping oat cake jelly soufflé donut jelly-o tootsie roll. Candy
        sweet cake. Tiramisu cookie toffee 
        donut. Chocolate pie croissant gummi
    ...
    <Media>
      ...
      <Media className="text-right" body>
        ...
        Fruitcake jelly beans marzipan sesame snaps.Jelly beans cake
    ...
    <Media>
      ...
      <Media className="text-right" body>
        ...
        cheesecake. Chocolate cake apple pie jelly-o 
        bear claw ice cream
        sugar plum biscuit. Lemon drops brownie biscuit jelly-o biscuit gummies.
      </Media>
