      ...
      <Row className="match-height">
        ...
        <Col xl="6" sm="12">
          ...
          <Card title="Left Aligned Media Object" code={mediaLeft}>
            ...
            <CardText>
               Use <code>left</code> prop with media tag to
              align you media to left.
            </CardText>
        ...
        <Col xl="6" sm="12">
          ...
          <Card title="Right Aligned Media Object" code={mediaRight}>
            ...
            <CardText>
               Use <code>right</code> prop with media tag to
              align you media to right.
            </CardText>
        ...
        <Col xl="6" sm="12">
          ...
          <Card title="Left Aligned Media Bordered" code={mediaLeftBordered}>
            ...
            <CardText>
               Wrap your medias with{" "}
              <code>.media-bordered</code> to create a bordered media.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Nested Media Objects" code={mediaNested}>
            ...
            <CardText>
               Add an extra media inside of your{" "}
              <code>MediaBody</code> to create a nested media.
            </CardText>
        ...
        <Col sm="12">
          ...
          <Card title="Media alignment" code={mediaAlignment}>
            ...
            <CardText>
               Use <code>.align-self-[center/end]</code>{" "}
              classes to vertically align your media
            </CardText>
