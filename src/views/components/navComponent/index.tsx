      ...
      <Row className="match-height">
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Center Alignment" code={navCenter}>
            ...
            <CardText>
               Use Class <code>.justify-content-center</code>{" "}
              with your 
        ...
        <Col md="6" sm="12">
          ...
          <Card title="End Alignment" code={navEnd}>
            ...
            <CardText>
               Use Class <code>.justify-content-end</code>{" "}
              with your 
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Vertical Nav" code={navVertical}>
            ...
            <CardText>
               Use prop <code>vertical</code> with nav tag to
              make it vertical.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Nav With square Border" code={navSquareBorder}>
            ...
            <CardText>
              ...
              <code>.square-border</code> class with <code>.wrap-border</code>{" "}
              class.
            </CardText>
        ...
        <Col md="6" sm="12">
          ...
          <Card title="Nav With Divider" code={navDivider}>
            ...
            <CardText>
               To add divider, use{" "}
              <code>.dropdown-divider</code> class to 
              <code>NavItem</code>
            </CardText>
